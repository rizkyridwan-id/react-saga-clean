    ...
    <>
      ...
      >
        ...
        >
          ...
          <img src={reduxSagaLogo} className="h-8" />
          Saga Dashboard
        </a>
        <nav
          aria-label="side navigation"
          ...
          <div>
            <ul className="flex flex-1 flex-col gap-1 py-3">
              <li className="px-3">
                <NavLink
                  to="/admin/dashboard"
                  className="flex items-center gap-3 rounded p-3 text-slate-700 transition-colors hover:bg-emerald-50 hover:text-emerald-500 focus:bg-emerald-200  aria-[current=page]:bg-emerald-100 aria-[current=page]:text-emerald-600 "
                >
          ...
          <div>
            <ul className="flex flex-1 flex-col gap-1 py-3">
              <li className="px-3">
                <NavLink
                  to="/admin/reports"
                  className="flex items-center gap-3 rounded p-3 text-slate-700 transition-colors hover:bg-emerald-50 hover:text-emerald-500 focus:bg-emerald-50 aria-[current=page]:bg-emerald-100 aria-[current=page]:text-emerald-600 "
                >
                  <div className="flex items-center self-center ">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
